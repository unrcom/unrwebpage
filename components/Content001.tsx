...
const page000 =
  ...
  "- 投票\n" +
  "  - さまざまなアンケートをカジュアルに作成できるサービスを開発してみたのですが、Googleフォームの存在を知り、本サービスの公開は挫折しました。\n\n" +
  "  - React + Redux Toolkit + TypeScript + Firebase を用いた開発経験を積み上げられましたので、これはこれでヨシとします。\n\n" +
  "- ３目並べ\n" +
  "  - 有名な [Reactチュートリアル](https://ja.reactjs.org/tutorial/tutorial.html) で紹介されている「３目並べ」ゲームを React Functional Component + Redux Toolkit + TypeScript + Firebase で再構築しました。\n\n" +
  "  - ログインしなくても対戦できますのでお試しください。\n\n" +
  "- ５目並べ\n" +
  "  - ３並べができたら次は５目並べですね。\n\n" +
  "  - ログインしなくても対戦できますのでお試しください。\n\n" +
  "  - ９路盤と１３路盤での囲碁対局にも利用できます。\n\n" +
  "  - ログインすると棋譜を残せます。\n\n" +
  "- カード\n" +
  "  - トランプを用いたカードゲームが体験できます。\n\n" +
  "  - ログインしなくても対戦できますのでお試しください。\n\n" +
  "  - １デッキ (１組のトランプ) から８デッキまで利用できます。\n\n" +
  "  - ログインするとチップ (賭け金) を記録できます。\n\n" +
  "";
...
const page241 =
  ...
  "１ドメイン当たり月額 0.5 から 0.6 USD の費用で運用できており、ドメイン維持に .com の場合年額 1.2 USD かかっています。\n";
